...
const categoryItems = [
    {id: 1, title: "Main Course", despriction: "(25 dishes)", image: "/images/home/category/img1.png"},
    {id: 2, title: "Appetizers", despriction: "(47 break fast)", image: "/images/home/category/img2.png"},
    {id: 3, title: "Dessert", despriction: "(12 dessert)", image: "/images/home/category/img3.png"},
    {id: 4, title: "Browse All", despriction: "(78 Items)", image: "/images/home/category/img4.png"}
]
  ...
  return (
    <div className={`max-w-screen-2xl container mx-auto xl:px-24 px-4 py-16 ${isDarkMode ? 'dark' : ''}`}>
        <div className='text-center'>
            ...
            <h2 className='title'>Meal kit Catagories</h2>
        </div>
