    ...
    <>
      ...
      <li tabIndex={0}>
        <details>
          ...
          <ul className="p-2 bg-white">
            ...
            <li>
              <a className="text-black">Salad</a>
            </li>
            <li>
              <a className="text-black">Pizza</a>
            </li>
          </ul>
        </details>
      </li>
      <li tabIndex={0}>
        <details>
          ...
          <ul className="p-2 bg-white">
            <li>
              <a className="text-black">Online Order</a>
            </li>
            <li>
              <a className="text-black">Table Booking</a>
            </li>
            <li>
              <a className="text-black">Order Tracking</a>
            </li>
          </ul>
        </details>
      </li>
      <li>
        <a className="text-black">Offers</a>
      </li>
    </>
  );
